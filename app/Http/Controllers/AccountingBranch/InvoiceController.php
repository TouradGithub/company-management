...
class InvoiceController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('financialaccountingbranch.invoices.index', compact('products', 'customers'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('financialaccountingbranch.invoices.create', compact('products','branches' , 'customers' , 'accounts'));
    }
    ...
    public function getInvoices(Request $request) {
        ...
        $invoices = $query->where('company_id',getCompanyId())->where('branch_id',getBranch()->id)->where('session_year',getCurrentYear())->with(['branch','customer' , 'Supplier'])->get();
...
//dd("OK");
    ...
    {
        $purchase = Invoice::where('branch_id' ,getBranch()->id)->where('invoice_number', $invoiceNumber)
            ->where('invoice_type', "Purchases")
            ->with('items')->first();
        if (!$purchase) {
            return response()->json(['message' => ' الفاتورة غير موجودة'], 404);
    ...
    public function sales()
    {
        ...
        return view('financialaccountingbranch.invoices.sales', compact( 'accounts', 'products', 'customers'));
    }
    ...
    public function purchasePage()
    {
        ...
        return view('financialaccountingbranch.invoices.purchase', compact( 'accounts', 'products', 'customers', 'suppliers'));
    }
    ...
    public function salesReturns()
    {
        ...
        return view('financialaccountingbranch.invoices.sales-return', compact( 'accounts', 'products', 'customers', 'suppliers'));
    }
    ...
    public function purchaseReturns()
    {
        ...
        return view('financialaccountingbranch.invoices.purchase-return', compact( 'accounts', 'products', 'customers', 'suppliers'));
    }
    ...
    public function printInvoice($id)
    {
        ...
        $html = view('financialaccountingbranch.invoices.exports.print', compact('invoice'))->render();
    ...
    public function editInvoice($id)
    {
        ...
        return view('financialaccountingbranch.invoices.' . $config['view'], compact(
            'invoice',  'accounts', 'products', 'customers','suppliers'
...
//        $invoice->invoice_number = Invoice::generateEntryNumber(getCompanyId());
        ...
        $invoice->branch_id =getBranch()->id;
    ...
    public function scanCodeQr($id)
    {
        ...
        return view('financialaccountingbranch.invoices.exports.print', compact('invoice'));
    }
