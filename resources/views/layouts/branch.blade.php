...
<body>
  ...
  ">
    ...
    <aside class="sidebar">
      ...
      <ul class="menu-items">
        <li class="menu-item {{ Request::routeIs('branch.overtimes.create') || Request::routeIs('branch.overtimes.index') ? 'active' : '' }}" data-section="overtime-form">
          <span class="menu-icon"><i class="bi bi-file-earmark-plus"></i></span>
          <a href="{{route('branch.overtimes.index')}}">الاضافي</a>
        </li>
        <li class="menu-item {{ Request::routeIs('branch.loans.create') || Request::routeIs('branch.loans.index') ? 'active' : '' }}" data-section="records">
            <span class="menu-icon"><i class="bi bi-table"></i></span>
            <a href="{{route('branch.loans.index')}}">السلف</a>

        </li>


        <li class="menu-item {{ Request::routeIs('branch.deductions.create') || Request::routeIs('branch.deductions.index') ? 'active' : '' }}" data-section="records">
            <span class="menu-icon"><i class="bi bi-table"></i></span>
            <a href="{{route('branch.deductions.index')}}">الخصومات</a>

          </li>

          <li class="menu-item {{ Request::routeIs('branch.leaves.create') || Request::routeIs('branch.leaves.index') ? 'active' : '' }}" data-section="records">
            <span class="menu-icon"><i class="bi bi-table"></i></span>
            <a href="{{route('branch.leaves.index')}}">الاجازات</a>
        ...
        <li class="menu-item " data-section="records">
            <span class="menu-icon"><i class="bi bi-table"></i></span>
            <a href="{{route('branch.employees.index')}}">الموظفين</a>

        </li>

        <li class="menu-item " data-section="records">
            <span class="menu-icon"><i class="bi bi-table"></i></span>
            <a href="{{route('branch.payrolls.index')}}">كشوف الرواتب</a>
