<div class="sidebar">
    ...
    {{-- <div class="nav-item" >
        <h3 class="nav-title"><a href="{{route('company.leaves.index')}}">Leaves</a></h3>
      </div> --}}
    {{-- <div class="nav-item" >
        <h3 class="nav-title"><a href="{{route('company.overtimes.index')}}">Overtime</a></h3>
      </div> --}}

    <div class="nav-item" onclick="showSection(&apos;employees-container&apos;)">
      <h3 class="nav-title"> <a href="{{route('company.employees.create')}}">Employes</a></h3>
    </div>
