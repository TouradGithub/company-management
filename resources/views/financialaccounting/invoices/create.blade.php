...
@section('content')
    ...
    <div class="nav-tabs">
        <button data-section="sales" class="active">فواتير المبيعات</button>
        <button data-section="purchase">فواتير المشتريات</button>
        <button data-section="sales-return">مرتجع المبيعات</button>
        <button data-section="purchase-return">مرتجع المشتريات</button>
    </div>
        ...
        <form id="salesInvoiceForm">
            ...
            <table id="salesItemsTable">
                ...
                <tr class="calculation-row">
                    <td colspan="5">الخصم (%) <input type="number" id="salesDiscountPercent" step="0.01" value="0"></td>
                    <td id="salesDiscountAmount">0.00</td>
                    <td></td>
                </tr>
                <tr class="calculation-row">
                    <td colspan="5">الضريبة (%) <input type="number" id="salesTaxPercent" step="0.01" value="15"></td>
    ...
    <div class="invoice-container hidden" id="purchase-invoice">
        <form id="purchaseInvoiceForm">
            ...
            <div class="info-section">
                <div class="client-info">
                    <h3>المورد:</h3>
                    <select name="supplier_id" class="suppliers purchase-supplier-id" id="purchaseCustomerSelect" style="width: 100%; padding: 10px; font-size: 16px;"></select>
                </div>
                <div class="company-info">
                    <h3>شركة بوادي المتحده {{ getCompany()->name }}</h3>
                    <p>شركة التجارة</p>
    ...
    <div class="invoice-container hidden" id="sales-return-invoice">
        <form id="salesReturnInvoiceForm">
            ...
            <div class="info-section supplier-return-info" style="border: 2px solid #e67e22; padding: 1.5rem; border-radius: 12px;  background: #fffaf5;">
                <div class="client-info" style="padding-right: 2rem; border-right: 2px dashed #e67e22;">
                    ...
                    <select name="customer_id" class="customers sales-return-customer-id" id="salesReturnCustomerSelect" style="width: 100%; padding: 10px; font-size: 16px;">
    ...
    <div class="invoice-container hidden" id="purchase-return-invoice">
        <form id="purchaseReturnInvoiceForm">
            <div class="header">
                <div>
                    <h1 style="color: var(--secondary);">فاتورة مرتجع مشتريات</h1>
                    <div style="display: flex; gap: 1rem; margin-top: 1rem;">
                        <p style="margin: 0; background: #e6f4ff; padding: 8px; border-radius: 4px; border: 1px solid var(--secondary);">
                            مرجع الفاتورة: <span id="purchaseReturnRef" style="font-weight: bold;">PR-{{ date('Ymd') }}-001</span>
                        </p>
                    </div>
                </div>
                <svg viewBox="0 0 40 40"></svg>
