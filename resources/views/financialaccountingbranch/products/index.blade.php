    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function fetchProducts() {
                showLoadingOverlay();
                $.ajax({
                    url: "{{ route('branch.products.fetch') }}",
                    type: "GET",
                    dataType: "json",
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    url: `/branch/products/edit/${productId}`,
                    type: 'GET',
                    success: function(response) {
                        if (response.success) {
            ...
            $(document).on('click', '.delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `/branch/products/delete/${productId}`,
                            type: 'DELETE',
            ...
            $('#productForm').on('submit', function (e) {
                ...
                const url = productId ? `/branch/products/update/${productId}` : "{{ route('branch.products.store') }}";
