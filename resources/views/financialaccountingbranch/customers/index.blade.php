    ...
    <script>
        $(document).ready(function () {
            ...
            $('#save-btn').on('click', function (e) {
                ...
                const url = customerId ? `/branch/customers/update/${customerId}` : '{{ route('branch.customers.store') }}';
            ...
            $(document).on('click', '.edit-customer', function (e) {
                ...
                $.ajax({
                    url: `/branch/customers/edit/${customerId}`,
                    type: 'GET',
                    success: function (response) {
                        if (response.success) {
            ...
            $(document).on('click', '.delete-customer', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `/branch/customers/delete/${customerId}`,
                            type: 'DELETE',
