    ...
    <script >
        ...
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        data.forEach(function (invoice) {
                            ...
                            let  printUrl= `/branch/invoices/print/${invoice.id}`;
                            ...
                            <a href="/branch/invoices/edit/${invoice.id}" style="text-decoration: none;" target="_blank">
                                <button class="action-btn view" title="عرض">
            ...
            $('#save-btn').on('click', function(e) {
                ...
                $.ajax({
                    url: '{{ route('branch.invoices.store') }}',
                    method: 'POST',
                    data: {
            ...
            $(document).on('click', '.delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `/branch/sales-invoices/${invoiceNumber}`,
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}'
                            },
