document.addEventListener('DOMContentLoaded', function() {
    ...
    function exportToExcel() {
        const rows = [];
        // Add header
        const headers = Array.from(accountsTable.querySelectorAll('thead th'))
    ...
    // Export to PDF
    document.querySelector('.export-pdf-btn').addEventListener('click', exportToPDF);

    function exportToPDF() {
        const element = accountsTable.cloneNode(true);
        ...
        // Convert inputs and selects to text
